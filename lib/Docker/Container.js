...
export const ContainerProvider = () => Provider.effect(Container, Effect.gen(function* () {
    ...
    const reconcileNetworks = Effect.fn(function* (live, news, olds) {
...
const isRandomHostPort = (external) => Number.parseInt(String(external), 10) === 0;
