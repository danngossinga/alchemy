...
const builtinAuth = Layer.mergeAll(AwsAuth, AxiomAuth, CloudflareAuth, FlyAuth, GitHubAuth, HetznerAuth, NeonAuth, PlanetscaleAuth, PrismaAuth, RailwayAuth);
