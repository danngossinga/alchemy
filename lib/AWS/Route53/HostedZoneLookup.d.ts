 ...
 */
export declare const resolveHostedZoneId: (hostedZoneId: string | undefined, domainName: string) => Effect.Effect<string, Error | import("effect/unstable/http/HttpClientError").HttpClientError, import("@distilled.cloud/aws/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
