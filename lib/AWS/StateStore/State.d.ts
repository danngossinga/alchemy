 ...
 * @resource
 */
export declare const state: (options?: S3StateOptions) => Layer.Layer<AWSEnvironment | Credentials | import("../../Auth/Credentials.ts").CredentialsStore | Region | State, never, import("../../index.ts").AuthProviders | import("effect/unstable/process/ChildProcessSpawner").ChildProcessSpawner | import("effect/FileSystem").FileSystem | HttpClient | import("effect/Path").Path | import("../../Auth/Profile.ts").ProfileStore>;
/**
 ...
 */
export declare const makeS3State: (options?: S3StateOptions) => Effect.Effect<StateService, never, AWSEnvironment | S3Deps>;
/**
 ...
 * @see https://docs.aws.amazon.com/AmazonS3/latest/userguide/gpbucketnamespaces.html#account-regional-gp-buckets
 */
export declare const createStateBucketName: (accountId: string, region: string) => string;
export {};
