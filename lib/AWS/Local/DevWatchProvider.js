 ...
 */
export const flociSidecarEntry = () => import.meta.resolve(import.meta.url.endsWith(".ts") ? "./Local.ts" : "./Local.js", import.meta.url);
/**
 ...
 */
export const makeDevWatchProvider = (cls, serverEntryUrl, spec) => RpcProvider.effect(cls, serverEntryUrl, Effect.gen(function* () {
