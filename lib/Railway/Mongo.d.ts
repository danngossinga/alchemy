...
export declare const DEFAULT_MONGO_IMAGE = "mongo:8";
export declare const DEFAULT_MONGO_USER = "mongo";
export declare const DEFAULT_MONGO_DATABASE = "railway";
export declare const MONGO_PORT = 27017;
export declare const MONGO_MOUNT_PATH = "/data/db";
export declare const MONGO_URL_SECRET = "MONGO_URL";
export declare const MONGO_PUBLIC_URL_SECRET = "MONGO_PUBLIC_URL";
/**
 ...
 */
export declare const MONGO_START_COMMAND = "docker-entrypoint.sh mongod --ipv6 --bind_ip ::,0.0.0.0 --setParameter diagnosticDataCollectionEnabled=false";
/**
...
export type Mongo = Resource<"Railway.Mongo", MongoProps, {
...
declare const MongoResource: import("../Resource.ts").ResourceClass<Mongo>;
/**
 ...
 * @resource
 */
export declare const Mongo: typeof MongoResource;
/**
 * IaC helper matching Railway's `mongo()`. Same resource as {@link Mongo}.
 */
export declare const mongo: import("../Resource.ts").ResourceClass<Mongo>;
declare const MongoNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.MongoNotCreated";
} & Readonly<A>;
export declare class MongoNotCreated extends MongoNotCreated_base<{
    name: string;
    projectId: string;
}> {
}
declare const MongoProjectRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.MongoProjectRequired";
} & Readonly<A>;
export declare class MongoProjectRequired extends MongoProjectRequired_base<{
    message: string;
}> {
}
declare const MongoDeployFailed_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.MongoDeployFailed";
} & Readonly<A>;
export declare class MongoDeployFailed extends MongoDeployFailed_base<{
    serviceId: string;
    status: string;
    deploymentId: string | undefined;
}> {
}
declare const MongoVolumeNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.MongoVolumeNotCreated";
} & Readonly<A>;
export declare class MongoVolumeNotCreated extends MongoVolumeNotCreated_base<{
    name: string;
    serviceId: string;
}> {
}
declare const MongoCommandError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.MongoCommandError";
} & Readonly<A>;
export declare class MongoCommandError extends MongoCommandError_base<{
    cause: unknown;
}> {
    get message(): string;
}
 ...
 */
export declare const pingMongo: (url: string) => Effect.Effect<{
    ok: number;
}, MongoCommandError>;
export declare const MongoProvider: () => import("effect/Layer").Layer<Provider.Provider<Mongo>, never, import("./Environment.ts").RailwayEnvironment | import("../Stack.ts").Stack | import("../Stage.ts").Stage | railway.RailwayOpContext>;
export {};
