import type { AuditLogEventTypeInfoResultItem } from "@distilled.cloud/railway";
...
export declare const getAuditLog: (options: {
    id: string;
    workspaceId?: string;
}) => Effect.Effect<AuditLogEntry, import("./Environment.ts").RailwayWorkspaceNotFound | railway.RailwayOpError, railway.RailwayOpContext>;
/**
 ...
 * ```
 */
export declare const listAuditLogEventTypes: () => Effect.Effect<railway.AuditLogEventTypeInfoResultList, railway.RailwayOpError, railway.RailwayOpContext>;
