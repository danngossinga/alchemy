...
export type CustomDomain = Resource<"Railway.CustomDomain", CustomDomainProps, {
...
declare const CustomDomainNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.CustomDomainNotCreated";
} & Readonly<A>;
export declare class CustomDomainNotCreated extends CustomDomainNotCreated_base<{
    domain: string;
    serviceId: string;
}> {
}
declare const CustomDomainServiceMissing_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.CustomDomainServiceMissing";
} & Readonly<A>;
export declare class CustomDomainServiceMissing extends CustomDomainServiceMissing_base<{
    domain: string;
}> {
}
export declare const CustomDomainProvider: () => import("effect/Layer").Layer<Provider.Provider<CustomDomain>, never, import("./Environment.ts").RailwayEnvironment | railway.RailwayOpContext>;
export {};
