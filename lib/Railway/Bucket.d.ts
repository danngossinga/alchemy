...
export declare const DEFAULT_BUCKET_REGION = "sjc";
...
export type Bucket = Resource<"Railway.Bucket", BucketProps, {
    /** Railway bucket id. */
    bucketId: string;
...
declare const BucketResource: import("../Resource.ts").ResourceClass<Bucket>;
/**
 ...
 * @resource
 */
export declare const Bucket: typeof BucketResource;
declare const BucketNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.BucketNotCreated";
} & Readonly<A>;
...
declare const BucketProjectRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.BucketProjectRequired";
} & Readonly<A>;
export declare class BucketProjectRequired extends BucketProjectRequired_base<{
    message: string;
}> {
}
declare const BucketEnvironmentRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.BucketEnvironmentRequired";
} & Readonly<A>;
export declare class BucketEnvironmentRequired extends BucketEnvironmentRequired_base<{
    message: string;
}> {
}
export declare const BucketProvider: () => import("effect/Layer").Layer<Provider.Provider<Bucket>, never, import("./Environment.ts").RailwayEnvironment | import("../Stack.ts").Stack | import("../Stage.ts").Stage | railway.RailwayOpContext>;
export {};
