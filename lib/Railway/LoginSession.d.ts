...
export declare const provideAnonymousRailway: <A, E>(effect: Effect.Effect<A, E, railway.RailwayOpContext>, apiBaseUrl?: string) => Effect.Effect<A, E>;
export declare const pollLoginSessionToken: (code: string) => Effect.Effect<string | undefined, railway.RailwayOpError, railway.RailwayOpContext>;
