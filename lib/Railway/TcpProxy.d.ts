...
export type TcpProxy = Resource<"Railway.TcpProxy", TcpProxyProps, {
 ...
 * @resource
 */
export declare const TcpProxy: import("../Resource.ts").ResourceClass<TcpProxy>;
declare const TcpProxyNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.TcpProxyNotCreated";
} & Readonly<A>;
export declare class TcpProxyNotCreated extends TcpProxyNotCreated_base<{
    serviceId: string;
    environmentId: string;
    applicationPort: number;
}> {
}
declare const TcpProxyTargetMissing_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.TcpProxyTargetMissing";
} & Readonly<A>;
export declare class TcpProxyTargetMissing extends TcpProxyTargetMissing_base<{
    message: string;
}> {
}
export declare const TcpProxyProvider: () => import("effect/Layer").Layer<Provider.Provider<TcpProxy>, never, import("./Environment.ts").RailwayEnvironment | railway.RailwayOpContext>;
export {};
//# sourceMappingURL=TcpProxy.d.ts.map