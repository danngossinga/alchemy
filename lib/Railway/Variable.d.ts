...
export type Variable = Resource<"Railway.Variable", VariableProps, {
...
declare const VariableResource: import("../Resource.ts").ResourceClass<Variable>;
/**
 ...
 * @resource
 */
export declare const Variable: typeof VariableResource;
declare const VariableNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.VariableNotCreated";
} & Readonly<A>;
export declare class VariableNotCreated extends VariableNotCreated_base<{
    projectId: string;
    environmentId: string;
    name: string;
}> {
}
declare const VariableProjectRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.VariableProjectRequired";
} & Readonly<A>;
export declare class VariableProjectRequired extends VariableProjectRequired_base<{
    message: string;
}> {
}
declare const VariableEnvironmentRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.VariableEnvironmentRequired";
} & Readonly<A>;
export declare class VariableEnvironmentRequired extends VariableEnvironmentRequired_base<{
    message: string;
}> {
}
export declare const VariableProvider: () => import("effect/Layer").Layer<Provider.Provider<Variable>, never, import("./Environment.ts").RailwayEnvironment | import("../Stack.ts").Stack | import("../Stage.ts").Stage | railway.RailwayOpContext>;
export {};
