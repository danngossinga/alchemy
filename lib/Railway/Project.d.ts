import type { CreateProjectResponse } from "@distilled.cloud/railway";
...
export declare const createProject: (input: {
    ...
    description?: string;
    defaultEnvironmentName?: string;
}) => Effect.Effect<CreateProjectResponse, railway.RailwayOpError, railway.RailwayOpContext>;
/**
...
export declare const ownedProjects: () => Effect.Effect<{
    ...
    /** Dashboard URL (`https://railway.com/project/{projectId}`). */
    url: string;
}[], railway.RailwayOpError, RailwayEnvironment | railway.RailwayOpContext>;
