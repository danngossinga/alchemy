import type { EnvironmentResponseVolumeInstancesEdgesItemNode, VolumeState } from "@distilled.cloud/railway";
...
export type Volume = Resource<"Railway.Volume", VolumeProps, {
    /** Railway volume id. */
    volumeId: string;
...
declare const VolumeResource: import("../Resource.ts").ResourceClass<Volume>;
/**
 ...
 * @resource
 */
export declare const Volume: typeof VolumeResource;
declare const VolumeNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.VolumeNotCreated";
} & Readonly<A>;
...
declare const VolumeProjectRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.VolumeProjectRequired";
} & Readonly<A>;
export declare class VolumeProjectRequired extends VolumeProjectRequired_base<{
    message: string;
}> {
}
declare const VolumeEnvironmentRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.VolumeEnvironmentRequired";
} & Readonly<A>;
export declare class VolumeEnvironmentRequired extends VolumeEnvironmentRequired_base<{
    message: string;
}> {
}
/** Volumes currently attached to a service instance. Used by Service reconcile. */
export declare const listServiceVolumes: (environmentId: string, projectId: string, serviceId: string) => Effect.Effect<EnvironmentResponseVolumeInstancesEdgesItemNode[], railway.BadRequest | railway.Conflict | railway.Forbidden | import("effect/unstable/http/HttpClientError").HttpClientError | railway.Locked | railway.RailwayForbidden | railway.RailwayInternalError | railway.RailwayParseError | railway.RailwayPlanLimitExceeded | railway.RailwayRateLimited | railway.RailwayServiceDomainCreateFailed | railway.RailwayUnauthenticated | railway.RailwayValidationError | railway.UnknownRailwayError | railway.UnprocessableEntity | import("@distilled.cloud/planetscale").DefaultErrors, railway.RailwayOpContext>;
export declare const VolumeProvider: () => import("effect/Layer").Layer<Provider.Provider<Volume>, never, import("./Environment.ts").RailwayEnvironment | import("../Stack.ts").Stack | import("../Stage.ts").Stage | railway.RailwayOpContext>;
export {};
