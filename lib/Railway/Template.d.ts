...
export type Template = Resource<"Railway.Template", TemplateProps, {
...
declare const TemplateResource: import("../Resource.ts").ResourceClass<Template>;
/**
 ...
 * @resource
 */
export declare const Template: typeof TemplateResource;
declare const TemplateNotFound_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.TemplateNotFound";
} & Readonly<A>;
export declare class TemplateNotFound extends TemplateNotFound_base<{
    templateId: string;
}> {
}
declare const TemplateNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.TemplateNotCreated";
} & Readonly<A>;
export declare class TemplateNotCreated extends TemplateNotCreated_base<{
    templateId: string;
    projectId: string;
}> {
}
declare const TemplateConfigRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.TemplateConfigRequired";
} & Readonly<A>;
export declare class TemplateConfigRequired extends TemplateConfigRequired_base<{
    templateId: string;
}> {
}
declare const TemplateWorkflowFailed_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.TemplateWorkflowFailed";
} & Readonly<A>;
export declare class TemplateWorkflowFailed extends TemplateWorkflowFailed_base<{
    workflowId: string;
    error: string;
}> {
}
export declare const TemplateProvider: () => import("effect/Layer").Layer<Provider.Provider<Template>, never, RailwayEnvironment | import("../Stack.ts").Stack | import("../Stage.ts").Stage | railway.RailwayOpContext>;
export {};
