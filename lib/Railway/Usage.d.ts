import type { EstimatedUsageResultItem, MetricMeasurement, MetricTag, UsageResultItem } from "@distilled.cloud/railway";
...
export type UsageLimit = Resource<"Railway.UsageLimit", UsageLimitProps, {
 ...
 * ```
 */
export declare const usage: (query: UsageQuery) => Effect.Effect<railway.UsageResultList, import("./Environment.ts").RailwayWorkspaceNotFound | railway.RailwayOpError, railway.RailwayOpContext>;
 ...
 * ```
 */
export declare const estimatedUsage: (query: EstimatedUsageQuery) => Effect.Effect<railway.EstimatedUsageResultList, import("./Environment.ts").RailwayWorkspaceNotFound | railway.RailwayOpError, railway.RailwayOpContext>;
declare const UsageLimitResource: import("../Resource.ts").ResourceClass<UsageLimit>;
/**
 ...
 * @resource
 */
export declare const UsageLimit: typeof UsageLimitResource;
declare const UsageLimitNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.UsageLimitNotCreated";
} & Readonly<A>;
export declare class UsageLimitNotCreated extends UsageLimitNotCreated_base<{
    customerId: string;
    workspaceId: string;
}> {
}
declare const UsageLimitWorkspaceNotFound_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.UsageLimitWorkspaceNotFound";
} & Readonly<A>;
export declare class UsageLimitWorkspaceNotFound extends UsageLimitWorkspaceNotFound_base<{
    workspaceId: string;
}> {
}
export declare const UsageLimitProvider: () => import("effect/Layer").Layer<Provider.Provider<UsageLimit>, never, RailwayEnvironment | railway.RailwayOpContext>;
