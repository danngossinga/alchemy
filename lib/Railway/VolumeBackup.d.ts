import type { VolumeInstanceBackupScheduleKind } from "@distilled.cloud/railway";
...
export type VolumeBackup = Resource<"Railway.VolumeBackup", VolumeBackupProps, {
...
declare const VolumeBackupResource: import("../Resource.ts").ResourceClass<VolumeBackup>;
/**
 ...
 * @resource
 */
export declare const VolumeBackup: typeof VolumeBackupResource;
declare const VolumeBackupNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.VolumeBackupNotCreated";
} & Readonly<A>;
export declare class VolumeBackupNotCreated extends VolumeBackupNotCreated_base<{
    name: string;
    volumeInstanceId: string;
}> {
}
declare const VolumeBackupVolumeRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.VolumeBackupVolumeRequired";
} & Readonly<A>;
export declare class VolumeBackupVolumeRequired extends VolumeBackupVolumeRequired_base<{
    message: string;
}> {
}
declare const VolumeBackupWorkflowFailed_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.VolumeBackupWorkflowFailed";
} & Readonly<A>;
export declare class VolumeBackupWorkflowFailed extends VolumeBackupWorkflowFailed_base<{
    workflowId: string;
    error: string;
}> {
}
 ...
 * online.
 */
export declare const restoreVolumePITR: (input: {
    volumeInstanceId: string;
    targetTimestamp: string;
    newServiceName?: string;
    sourceRepoPath?: string;
}) => Effect.Effect<railway.RestoreVolumeInstancePITRResponse, railway.BadGateway | railway.BadRequest | railway.Conflict | railway.Forbidden | railway.GatewayTimeout | import("effect/unstable/http/HttpClientError").HttpClientError | railway.InternalServerError | railway.Locked | railway.NotFound | railway.RailwayForbidden | railway.RailwayInternalError | railway.RailwayNotFound | railway.RailwayParseError | railway.RailwayPlanLimitExceeded | railway.RailwayRateLimited | railway.RailwayServiceDomainCreateFailed | railway.RailwayUnauthenticated | railway.RailwayValidationError | railway.ServiceUnavailable | railway.TooManyRequests | railway.Unauthorized | railway.UnknownRailwayError | railway.UnprocessableEntity | VolumeBackupWorkflowFailed, railway.RailwayOpContext>;
export declare const VolumeBackupProvider: () => import("effect/Layer").Layer<Provider.Provider<VolumeBackup>, never, import("./Environment.ts").RailwayEnvironment | import("../Stack.ts").Stack | import("../Stage.ts").Stage | railway.RailwayOpContext>;
export {};
