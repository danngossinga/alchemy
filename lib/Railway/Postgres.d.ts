...
export declare const DEFAULT_POSTGRES_IMAGE = "ghcr.io/railwayapp-templates/postgres-ssl:16";
export declare const DEFAULT_POSTGRES_USER = "postgres";
export declare const DEFAULT_POSTGRES_DATABASE = "railway";
export declare const POSTGRES_PORT = 5432;
export declare const POSTGRES_MOUNT_PATH = "/var/lib/postgresql/data";
export declare const POSTGRES_PGDATA = "/var/lib/postgresql/data/pgdata";
...
export type Postgres = Resource<"Railway.Postgres", PostgresProps, {
...
declare const PostgresResource: import("../Resource.ts").ResourceClass<Postgres>;
/**
 ...
 * @resource
 */
export declare const Postgres: typeof PostgresResource;
declare const PostgresNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.PostgresNotCreated";
} & Readonly<A>;
...
declare const PostgresProjectRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.PostgresProjectRequired";
} & Readonly<A>;
export declare class PostgresProjectRequired extends PostgresProjectRequired_base<{
    message: string;
}> {
}
declare const PostgresDeployFailed_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.PostgresDeployFailed";
} & Readonly<A>;
export declare class PostgresDeployFailed extends PostgresDeployFailed_base<{
    serviceId: string;
    status: string;
    deploymentId: string | undefined;
}> {
}
declare const PostgresVolumeNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.PostgresVolumeNotCreated";
} & Readonly<A>;
export declare class PostgresVolumeNotCreated extends PostgresVolumeNotCreated_base<{
    name: string;
    serviceId: string;
}> {
}
export declare const privateConnectionUri: (input: {
    user: string;
    password: string;
    name: string;
    database: string;
}) => string;
export declare const publicConnectionUri: (input: {
    user: string;
    password: string;
    domain: string;
    port: number;
...
export declare const PostgresProvider: () => import("effect/Layer").Layer<Provider.Provider<Postgres>, never, import("./Environment.ts").RailwayEnvironment | import("../Stack.ts").Stack | import("../Stage.ts").Stage | railway.RailwayOpContext>;
