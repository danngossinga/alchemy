...
export type Group = Resource<"Railway.Group", GroupProps, {
...
declare const GroupResource: import("../Resource.ts").ResourceClass<Group>;
/**
 ...
 * @resource
 */
export declare const Group: typeof GroupResource;
declare const GroupProjectRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.GroupProjectRequired";
} & Readonly<A>;
export declare class GroupProjectRequired extends GroupProjectRequired_base<{
    message: string;
}> {
}
declare const GroupEnvironmentRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.GroupEnvironmentRequired";
} & Readonly<A>;
export declare class GroupEnvironmentRequired extends GroupEnvironmentRequired_base<{
    message: string;
}> {
}
export declare const GroupProvider: () => import("effect/Layer").Layer<Provider.Provider<Group>, never, import("./Environment.ts").RailwayEnvironment | import("../Stack.ts").Stack | import("../Stage.ts").Stage | railway.RailwayOpContext>;
export {};
