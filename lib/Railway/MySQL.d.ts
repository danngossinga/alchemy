...
export declare const DEFAULT_MYSQL_IMAGE = "mysql:9";
export declare const DEFAULT_MYSQL_USER = "root";
export declare const DEFAULT_MYSQL_DATABASE = "railway";
export declare const MYSQL_PORT = 3306;
export declare const MYSQL_MOUNT_PATH = "/var/lib/mysql";
export declare const MYSQL_URL_SECRET = "MYSQL_URL";
export declare const MYSQL_PUBLIC_URL_SECRET = "MYSQL_PUBLIC_URL";
/** Railway's official MySQL template start command (native AIO fails on volumes). */
export declare const DEFAULT_MYSQL_START_COMMAND = "docker-entrypoint.sh mysqld --innodb-use-native-aio=0 --disable-log-bin --performance_schema=0";
/**
...
export type MySQL = Resource<"Railway.MySQL", MySQLProps, {
...
declare const MySQLResource: import("../Resource.ts").ResourceClass<MySQL>;
/**
 ...
 * @resource
 */
export declare const MySQL: typeof MySQLResource;
/**
 * IaC helper matching Railway's `mysql()`. Same resource as {@link MySQL}.
 */
export declare const mysql: import("../Resource.ts").ResourceClass<MySQL>;
declare const MySQLNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.MySQLNotCreated";
} & Readonly<A>;
export declare class MySQLNotCreated extends MySQLNotCreated_base<{
    name: string;
    projectId: string;
}> {
}
declare const MySQLProjectRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.MySQLProjectRequired";
} & Readonly<A>;
export declare class MySQLProjectRequired extends MySQLProjectRequired_base<{
    message: string;
}> {
}
declare const MySQLDeployFailed_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.MySQLDeployFailed";
} & Readonly<A>;
export declare class MySQLDeployFailed extends MySQLDeployFailed_base<{
    serviceId: string;
    status: string;
    deploymentId: string | undefined;
}> {
}
declare const MySQLVolumeNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.MySQLVolumeNotCreated";
} & Readonly<A>;
export declare class MySQLVolumeNotCreated extends MySQLVolumeNotCreated_base<{
    name: string;
    serviceId: string;
}> {
}
export declare const MySQLProvider: () => import("effect/Layer").Layer<Provider.Provider<MySQL>, never, import("./Environment.ts").RailwayEnvironment | import("../Stack.ts").Stack | import("../Stage.ts").Stage | railway.RailwayOpContext>;
export {};
