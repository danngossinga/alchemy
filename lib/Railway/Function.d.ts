...
import { type RailwayBuildOptions, type RailwayHostRuntimeContext } from "./hosted.ts";
...
export declare const FUNCTION_RUNTIME_NAME: "bun";
/** Start-command prefix the Bun function runtime uses to decode source. */
export declare const FUNCTION_START_PREFIX = "./run.sh ";
/**
 ...
 */
export declare const FUNCTION_MAX_BYTES: number;
/**
 ...
 */
export declare const isFunctionImage: (image: string | null | undefined) => boolean;
export interface FunctionProps<Env extends Record<string, any> = Record<string, any>> extends PlatformProps {
    /**
...
export type Function<Env extends Record<string, any> = Record<string, any>> = Resource<"Railway.Function", FunctionProps<Env>, {
    /** Railway service id. */
    serviceId: string;
 ...
 * @resource
 */
export declare const Function: Platform<Function, FunctionServices, FunctionShape, FunctionRuntimeContext> & {
    /**
     * Async (no-impl) constructor — captures the `env` literal so
     * {@link InferEnv} types the handler's second argument.
     */
    <const Env extends Record<string, any>, PropsReq = never>(id: string, props: InputProps<FunctionProps<Env>> | Effect.Effect<InputProps<FunctionProps<Env>>, never, PropsReq>): Effect.Effect<Function<Env>, never, Providers | PropsReq>;
};
declare const FunctionNotCreated_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.FunctionNotCreated";
} & Readonly<A>;
export declare class FunctionNotCreated extends FunctionNotCreated_base<{
    name: string;
    projectId: string;
}> {
}
declare const FunctionProjectRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.FunctionProjectRequired";
} & Readonly<A>;
export declare class FunctionProjectRequired extends FunctionProjectRequired_base<{
    message: string;
}> {
}
declare const FunctionSourceRequired_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.FunctionSourceRequired";
} & Readonly<A>;
export declare class FunctionSourceRequired extends FunctionSourceRequired_base<{
    message: string;
}> {
}
declare const FunctionTooLarge_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.FunctionTooLarge";
} & Readonly<A>;
export declare class FunctionTooLarge extends FunctionTooLarge_base<{
    bytes: number;
    maxBytes: number;
}> {
    get message(): string;
}
declare const FunctionRuntimeImageMissing_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.FunctionRuntimeImageMissing";
} & Readonly<A>;
export declare class FunctionRuntimeImageMissing extends FunctionRuntimeImageMissing_base<{
    message: string;
}> {
}
declare const FunctionDeployFailed_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Railway.FunctionDeployFailed";
} & Readonly<A>;
export declare class FunctionDeployFailed extends FunctionDeployFailed_base<{
    serviceId: string;
    status: string;
    deploymentId: string | undefined;
    logs: string;
...
export declare const FunctionProvider: () => import("effect/Layer").Layer<Provider.Provider<Function<Record<string, any>>>, never, FileSystem.FileSystem | import("effect/Path").Path | import("./Environment.ts").RailwayEnvironment | Stack | import("../Stage.ts").Stage | railway.RailwayOpContext>;
