import type { CloudAgentSleepResponse, CloudAgentStatus, CloudAgentWakeResponse } from "@distilled.cloud/railway";
...
}) => Effect.Effect<CloudAgentSleepResponse, railway.RailwayOpError, railway.RailwayOpContext>;
/**
...
export declare const wakeCloudAgent: (agent: string | {
    readonly cloudAgentId: string;
}) => Effect.Effect<CloudAgentWakeResponse, railway.RailwayOpError, railway.RailwayOpContext>;
export declare const CloudAgentProvider: () => import("effect/Layer").Layer<Provider.Provider<CloudAgent>, never, import("./Environment.ts").RailwayEnvironment | import("../Stack.ts").Stack | import("../Stage.ts").Stage | railway.RailwayOpContext>;
export {};
