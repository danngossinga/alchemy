 ...
 */
export declare const importD1Database: (options: ImportDatabaseOptions) => Effect.Effect<ImportDatabaseResult, import("@distilled.cloud/fly-io").BadGateway | import("@distilled.cloud/cloudflare").CloudflareError | import("@distilled.cloud/cloudflare").CloudflareHttpError | import("@distilled.cloud/cloudflare").CloudflareParseError | import("@distilled.cloud/cloudflare").CloudflareRateLimited | import("@distilled.cloud/fly-io").ConfigError | import("@distilled.cloud/fly-io").GatewayTimeout | import("effect/unstable/http/HttpClientError").HttpClientError | import("@distilled.cloud/fly-io").InternalServerError | d1.InvalidObjectIdentifier | import("@distilled.cloud/cloudflare").InvalidRoute | import("@distilled.cloud/cloudflare").OAuthRefreshError | import("@distilled.cloud/fly-io").ServiceUnavailable | import("@distilled.cloud/fly-io").TooManyRequests | import("@distilled.cloud/fly-io").Unauthorized | import("@distilled.cloud/cloudflare").UnknownCloudflareError, d1.CloudflareOpContext>;
//# sourceMappingURL=ImportDatabase.d.ts.map