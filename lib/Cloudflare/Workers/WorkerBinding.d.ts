 ...
 * runtime consumes it.
 */
export type R2BucketWorkerBinding = Extract<DistilledWorkerBinding, {
    type: "r2_bucket";
}> & {
 ...
 */
export type WireWorkerBinding = Exclude<WorkerBinding, SelfUrlWorkerBinding | SelfServiceWorkerBinding | R2BucketWorkerBinding> | Extract<DistilledWorkerBinding, {
    type: "r2_bucket";
}>;
export type WorkerBinding = Exclude<DistilledWorkerBinding, {
    ...
    type: "service";
}> | DurableObjectNamespaceWorkerBinding | QueueWorkerBinding | R2BucketWorkerBinding | ServiceWorkerBinding | SelfUrlWorkerBinding | SelfServiceWorkerBinding;
