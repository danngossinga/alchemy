...
}, {}, import("effect/PlatformError").PlatformError | Schema.SchemaError | import("effect/unstable/http/HttpServerError").ServeError | import("./errors.ts").UserInputError, import("effect/unstable/process/ChildProcessSpawner").ChildProcessSpawner | FileSystem.FileSystem>;
