 ...
 */
export declare function TaskRow({ icon, iconColor, spinning, label, detail, depth, children, }: TaskRowProps): import("react").JSX.Element;
...
export declare function ProgressGroup({ rows, width, labelWidth, }: ProgressGroupProps): import("react").JSX.Element;
export declare class LiveStore<Value> {
    private value;
    ...
    readonly update: (f: (value: Value) => Value) => void;
}
export declare const useLiveStore: <Value>(store: LiveStore<Value>) => Value;
export {};
