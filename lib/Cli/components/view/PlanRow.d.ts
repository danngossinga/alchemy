...
export declare const namespaceStyle: (action: string) => (typeof actionStyle)[PlanAction];
...
export declare function NamespaceRow({ id, depth, action, }: NamespaceRowProps): JSX.Element;
export {};
//# sourceMappingURL=PlanRow.d.ts.map