...
const devRunMode = import.meta.url.includes("/node_modules/")
    ...
    : `${typeof globalThis.Bun !== "undefined"
        ...
        : `node ${process.versions.node}`}, ${import.meta.url.endsWith(".ts") ? "src" : "lib"}`;
...
// wins over this one.
Layer.succeed(ArtifactStore, createArtifactStore()), FetchHttpClient.layer, ConfigProvider.layer(ConfigProvider.fromEnv()), routeCacheLayer, Layer.provide(Layer.provideMerge(Layer.mergeAll(selectCliServices(), CliKit.CliKitInteraction), CliKit.layer()), PlatformServices), 
