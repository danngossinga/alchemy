...
export declare const effect: <R extends ResourceLike, Req = never, ReadReq = never, DiffReq = never, PrecreateReq = never, ReconcileReq = never, DeleteReq = never, TailReq = never, LogsReq = never, ListReq = never>(cls: ResourceClassLike<R> | Platform<R, any, any, any, any, any>, serverEntryUrl: string, eff: Effect.Effect<RpcProviderService<R, ReadReq, DiffReq, PrecreateReq, ReconcileReq, DeleteReq, TailReq, LogsReq, ListReq>, never, Req>) => Layer.Layer<Provider.Provider<R>, never, AlchemyContext | ArtifactStore | Stack | Exclude<DeleteReq, Artifacts | InstanceId> | Exclude<DiffReq, Artifacts | InstanceId> | Exclude<ListReq, Artifacts | InstanceId> | Exclude<PrecreateReq, Artifacts | InstanceId> | Exclude<ReadReq, Artifacts | InstanceId> | Exclude<ReconcileReq, Artifacts | InstanceId> | Exclude<Req, Artifacts | InstanceId>>;
/**
